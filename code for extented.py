...
def split_video_with_multiple_texts(input_video_path, output_folder, segment_duration=60, square_resolution=1080):
        ...
        try:
            ...
            ffmpeg.input(input_video_path, ss=start_time, t=segment_duration).output(
                ...
                vf=f'scale={square_resolution}:{square_resolution}:force_original_aspect_ratio=decrease,'
                   ...
                   f'drawtext=fontfile=/path/to/font.ttf:text=\'{part_text}\':fontcolor=white:fontsize=54:x=(w-text_w)/2:y=180,'
                   f'drawtext=fontfile=/path/to/font.ttf:text=\'{movie_title}\':fontcolor=White:fontsize=54:x=(w-text_w)/2:y=880',
                vcodec='libx264',
                acodec='aac',
                preset='ultrafast',
                movflags='faststart'
...
# Example usage
input_video_path = r"C:\Users\balaji\Videos\movies\test.mp4"
output_folder = r"C:\Users\balaji\Videos\Aim Lab\output"
